var PoiRadar = {
    ...
    show: function initFn() {
        ...
        AR.radar.background = new AR.ImageResource("https://raw.githubusercontent.com/Wikitude/wikitude-sdk-samples/master/10_BrowsingPois_2_AddingRadar/assets/radar_bg.png", {
        ...
        /*
            ...
            north-indicator).
         */
        AR.radar.northIndicator.image = new AR.ImageResource("https://raw.githubusercontent.com/Wikitude/wikitude-sdk-samples/master/10_BrowsingPois_2_AddingRadar/assets/radar_north.png", {
            onError: World.onError
        });
